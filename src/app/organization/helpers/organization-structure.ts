export const organizationStructure = [
  { label: 'Nombre', formControlName: 'emp_nom', type: 'text', col: '12' },
  { label: 'RUC', formControlName: 'emp_ruc', type: 'text', col: '12' },
  { label: 'Correo', formControlName: 'emp_correo', type: 'email', col: '12' },
